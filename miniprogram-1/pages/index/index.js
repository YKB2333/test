Page({
  ...
  change(e) {
    ...
    if (query == "BJ") {
      url += `&BJ_BuHuo=${this.data.BJ_BuHuo}&BJ_XiangWeiNumber=${this.data.child.BJ_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "SY") {
      url += `&SY_BuHuo=${this.data.SY_BuHuo}&SY_XiangWeiNumber=${this.data.child.SY_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "CD") {
      url += `&CD_BuHuo=${this.data.CD_BuHuo}&CD_XiangWeiNumber=${this.data.child.CD_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "GZ") {
      url += `&GZ_BuHuo=${this.data.GZ_BuHuo}&GZ_XiangWeiNumber=${this.data.child.GZ_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "JN") {
      url += `&JN_BuHuo=${this.data.JN_BuHuo}&JN_XiangWeiNumber=${this.data.child.JN_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "SH") {
      url += `&SH_BuHuo=${this.data.SH_BuHuo}&SH_XiangWeiNumber=${this.data.child.SH_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "WH") {
      url += `&WH_BuHuo=${this.data.WH_BuHuo}&WH_XiangWeiNumber=${this.data.child.WH_XiangWeiNumber}`
      this.setData({
        child: {
    ...
    if (query == "XA") {
      url += `&XA_BuHuo=${this.data.XA_BuHuo}&XA_XiangWeiNumber=${this.data.child.XA_XiangWeiNumber}`
      this.setData({
        child: {
